...
################################################################################
# Set Model
model_og = ModelWrapper(SEEIIRNR_NB4_deaths(), param_seeiirnr_NB4_deaths_daily, args_param_seeiirnr_deaths_daily)
_vals = (:β, :γ, :ϵ, :p_states, :p_thirdstate, :r, :ψ, :ϕ) # :ϕ
