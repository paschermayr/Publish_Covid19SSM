...
################################################################################
# Set Model
model_og = ModelWrapper(SEEIIRNR_NB5_deathscases(), param_seeiirnr_NB5_deathscases_daily, args_param_seeiirnr_deathscases_daily)
_vals = (:β, :γ, :ϵ, :p_states, :p_thirdstate, :r, :ψ, :ϕ_cases, :ϕ_deaths) # :ϕ
